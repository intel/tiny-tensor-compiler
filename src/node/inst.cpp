...
auto tinytc_inst::kind() -> inst_execution_kind {
    switch (type_id()) {
    case IK::IK_alloca:
    case IK::IK_lifetime_stop:
    case IK::IK_foreach:
    case IK::IK_parallel:
    case IK::IK_blas_a2:
    case IK::IK_axpby:
    ...
    case IK::IK_im:
    case IK::IK_re:
    case IK::IKEND_arith_unary:
    case IK::IK_loop:
    case IK::IK_for:
    case IK::IKEND_loop:
        return inst_execution_kind::mixed;
    case IK::IK_cooperative_matrix_apply:
    case IK::IK_cooperative_matrix_extract:
    case IK::IK_cooperative_matrix_insert:
    case IK::IK_cooperative_matrix_load:
    case IK::IK_cooperative_matrix_mul_add:
    case IK::IK_cooperative_matrix_prefetch:
    case IK::IK_cooperative_matrix_reduce:
    case IK::IK_cooperative_matrix_scale:
    case IK::IK_cooperative_matrix_store:
