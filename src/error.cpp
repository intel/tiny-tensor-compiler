...
char const *tinytc_error_string(tinytc_status_t status) {
    ...
    case tinytc_status_ir_expected_memref_order_0:
        return "Expected memref of order 0 (scalar)";
    case tinytc_status_ir_expected_memref_order_1:
        return "Expected memref of order 1 (vector)";
    case tinytc_status_ir_expected_memref_order_2:
        return "Expected memref of order 2 (matrix)";
    case tinytc_status_ir_expected_memref_order_0_or_1:
        return "Expected memref of order 0 or 1 (scalar or vector)";
    case tinytc_status_ir_expected_memref_order_1_or_2:
        return "Expected memref of order 1 or 2 (vector or matrix)";
    case tinytc_status_ir_expected_memref_order_0_1_or_2:
        return "Expected memref of order 0, 1, or 2 (scalar, vector, or matrix)";
    ...
    case tinytc_status_ir_expected_non_scalar_memref:
        return "Expected memref of dimension greater or equal than 1";
    // SPIR-V
