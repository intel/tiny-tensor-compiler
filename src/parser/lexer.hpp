...
class lexer {
  public:
    ...
    void error(ir::location const &l, std::string const &m);
  ...
  private:
    ...
    ir::scalar_type lex_integer_type(char const *s, char const *e);
    ir::scalar_type lex_floating_type(char const *s, char const *e);
