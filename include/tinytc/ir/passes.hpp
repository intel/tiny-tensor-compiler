...
//! Generate OpenCL AST
TINYTC_EXPORT clir::prog generate_opencl_ast(prog p, std::shared_ptr<core_info> info);
...
TINYTC_EXPORT void set_work_group_size(func f, std::shared_ptr<core_info> info);
//! Choose work group and subgroup size heuristically if not given explicitly
